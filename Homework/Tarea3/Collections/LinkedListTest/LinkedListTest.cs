...
namespace LinkedListTest
{
    ...
    public class LinkedListTest
    {
        ...
        {
            list = new Collections.LinkedList<int>();
            Collections.LinkedList<int> list2 = new Collections.LinkedList<int>();
            Collections.LinkedList<int> list3 = new Collections.LinkedList<int>();
        ...
        {
            Collections.LinkedList<int> intsList = new Collections.LinkedList<int>();// -> INT TYPE WAS TESTED
            Collections.LinkedList<double> doublesList = new Collections.LinkedList<double>();
            Collections.LinkedList<String> strsList = new Collections.LinkedList<String>();
            Collections.LinkedList<Persona> personsList = new Collections.LinkedList<Persona>();
